		    ...
		    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
		      <ul class="navbar-nav justify-content-center">
		    	<% if(user != null && user.getSerialNumber()!=0 && (user instanceof Employee)){ %>
		   		...
		   		<%} %>
		   		<% if(user != null && user.getSerialNumber()!=0 && (user instanceof Worker)){ %>
		      		<li class="nav-item"><a class="nav-link active" href="homepage"><span class="glyphicon"></span>Maintenances</a></li>
		   		<%} %>
