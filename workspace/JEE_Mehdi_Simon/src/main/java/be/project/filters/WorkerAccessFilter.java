...
public class WorkerAccessFilter implements Filter {

	private FilterConfig filterConfig;
	
    public WorkerAccessFilter() {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(user instanceof Worker) {
			...
			System.out.println("Le filtre " + this.filterConfig.getFilterName() + " a bloqué la requête à la servlet --> Vous devez être worker pour accèder à cette ressource");
