...
public class Maintenance implements Serializable {
	...
	public Maintenance(int maintenanceId2, Date maintenance_date, LocalTime startTime2, FactoryMachine machine2,
			MaintenanceStatus status2, ArrayList<Worker> workers, Leader leader, LocalTime endTime2,
			ArrayList<Report> reports) {
		this(maintenanceId2,maintenance_date,machine2,status2,workers,leader,startTime2,endTime2);
